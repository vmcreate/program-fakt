...
@Component({
  selector: 'statistika-klijenta',
  templateUrl: './statistika-klijenta.component.html',
  styleUrls: ['./statistika-klijenta.component.css']
})
export class StatistikaKlijentaComponent implements OnInit, OnDestroy {
  dataSource?: any;
  racuni?: Array<any> = [];
